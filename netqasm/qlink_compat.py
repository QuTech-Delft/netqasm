...
def request_to_qlink_1_0(
    ...
    if request.type == RequestType.K:
        ...
        return qlink_1_0.ReqMeasureDirectly(
            ...
            x_rotation_angle_local_1=request.rotation_local_1,
            y_rotation_angle_local=request.rotation_local_2,
            x_rotation_angle_local_2=request.rotation_local_3,
            x_rotation_angle_remote_1=request.rotation_remote_1,
            y_rotation_angle_remote=request.rotation_remote_2,
            x_rotation_angle_remote_2=request.rotation_remote_3,
